...
AS
BEGIN
    SELECT USER_ID, USER_FIRST_NAME + ' ' + USER_LAST_NAME AS USER_FULL_NAME, USER_EMAIL, USER_PHONENUMBER, USER_PROFILE_PICTURE_PATH, USER_BIRTHDATE, USER_GENDER_NAME, COUNTRY_NAME, USER_ADRESS, USER_JOB_NAME, USER_ACADEMIC_LEVEL_NAME, USER_LEVEL_NAME
    FROM VW_USERS_NON_SENSITIVE_INFORMATION (NOLOCK) WHERE USER_JOB_NAME = @JOB_NAME
END
